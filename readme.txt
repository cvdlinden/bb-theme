...
-------------------------------------------------------
Bij Best theme, Copyright 2016 colorlib.com
Bij Best WordPress theme is distributed under the terms of the GNU GPL
Bij Best is based on Underscores http://underscores.me/, (C) 2012-2016 Automattic, Inc.
-------------------------------------------------------

== Description ==

Bij Best is a powerful and versatile one page WordPress theme with pixel perfect design and outstanding functionality. It is by far the most advanced free WordPress theme available today with loads of unmatched customization options. This theme comes with several homepage widgets that can be used to add portfolio, testimonials, parallax sections, your product or service information, call for action and much more.

Bij Best supports most free and premium WordPress plugins such as WooCommerce, Jetpack, Gravity Forms, Contact Form 7, Yoast SEO, Google Analytics by Yoast and much more.
...
For more detailed Bij Best theme setup please read documentation: https://colorlib.com/wp/support/shapely/

== Frequently Asked Questions ==

= Does this theme support any plugins? =

Bij Best includes support for Infinite Scroll, Portfolio, Testimonials, Tiled Galleries for Jetpack.
