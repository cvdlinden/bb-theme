...
/**
 * [BB] Homepage features section Widget
 * Bij Best Theme
 */
class bb_home_features extends WP_Widget {
	...
	function form($instance) {
		...
		<?php for ( $i=1; $i<4; $i++ ) { ?>
			...
			<p><label for="<?php echo $this->get_field_id('title'.$i); ?>"><?php esc_html_e('Title ','bb') ?></label>
			...
			<p><label for="<?php echo $this->get_field_id('icon'.$i); ?>"><?php esc_html_e('Icon( Font Awsome ) ','bb') ?></label><?php
				...
				<select class="bb-icon" id="<?php echo $this->get_field_id('icon'.$i); ?>" name="<?php echo $this->get_field_name( 'icon'.$i ); ?>">
					<option value=""><?php _e( 'Select Icon', 'bb' ); ?></option>
			...
			<p><label for="<?php echo $this->get_field_id('body_content'.$i); ?>"><?php esc_html_e('Content ','bb') ?></label>
