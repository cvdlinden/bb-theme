...
/**
 * [BB] Homepage parralax section Widget
 * Bij Best Theme
 */
class bb_home_parallax extends WP_Widget {
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_name( 'image_src' ); ?>"><?php _e( 'Image:', 'bb' ); ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('image_pos'); ?>"><?php esc_html_e('Image Position ','bb') ?></label>
			<select name="<?php echo $this->get_field_name('image_pos'); ?>"
					id="<?php $this->get_field_id('image_pos'); ?>" class="widefat">
					<option value="left" <?php selected( $instance['image_pos'], 'left' ); ?>><?php _e('Left', 'bb'); ?></option>
					<option value="right" <?php selected( $instance['image_pos'], 'right' ); ?>><?php _e('Right', 'bb'); ?></option>
					<option value="top" <?php selected( $instance['image_pos'], 'top' ); ?>><?php _e('Top', 'bb'); ?></option>
					<option value="bottom" <?php selected( $instance['image_pos'], 'bottom' ); ?>><?php _e('Bottom', 'bb'); ?></option>
					<option value="background-full" <?php selected( $instance['image_pos'], 'background-full' ); ?>><?php _e('Background Full', 'bb'); ?></option>
					<option value="background-small" <?php selected( $instance['image_pos'], 'background-small' ); ?>><?php _e('Background Small', 'bb'); ?></option>
			</select>
		</p>

		<p><label for="<?php echo $this->get_field_id('button1'); ?>"><?php esc_html_e('Button 1 Text ','bb') ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('button1_link'); ?>"><?php esc_html_e('Button 1 Link ','bb') ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('button2'); ?>"><?php esc_html_e('Button 2 Text ','bb') ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('button2_link'); ?>"><?php esc_html_e('Button 2 Link ','bb') ?></label>
