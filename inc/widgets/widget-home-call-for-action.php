<?php
/**
 * [BB] Homepage Call for Action section Widget
 * Bij Best Theme
 */
...
class bb_home_CFA extends WP_Widget {
	...
	?>
		...
		<p><label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e('Callout Text ','bb') ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('button'); ?>"><?php esc_html_e('Button Text ','bb') ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('button_link'); ?>"><?php esc_html_e('Button Link ','bb') ?></label>
