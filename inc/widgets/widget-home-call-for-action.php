 ...
 * Bij Best Theme
 */
class bb_theme_home_CFA extends WP_Widget
{
    function __construct(){

        $widget_ops = array('classname' => 'bb_theme_home_CFA','description' => esc_html__( "[Bij Best] Call for Action Section" ,'bb-theme') );
        parent::__construct('bb_theme_home_CFA', esc_html__('[Bij Best] Call for Action Section For FrontPage','bb-theme'), $widget_ops);
    }
    ...
    ?>
      ...
      <p><label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e('Callout Text ','bb-theme') ?></label>
      ...
      <p><label for="<?php echo $this->get_field_id('button'); ?>"><?php esc_html_e('Button Text ','bb-theme') ?></label>
      ...
      <p><label for="<?php echo $this->get_field_id('button_link'); ?>"><?php esc_html_e('Button Link ','bb-theme') ?></label>
