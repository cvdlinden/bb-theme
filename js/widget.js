jQuery(document).ready( function($) {
  ...
  /* Cloning of Logo Client Widgets */
  jQuery(document).on("widget-added", function() { //function(e, widget){
    bbSort();
  });
  jQuery(document).on("widget-updated", function() { //function(e, widget){
    bbSort();
  });
  ...
  function bbSort(){
      jQuery(".client-sortable").sortable({
         handle: ".logo_heading" })
         .bind( "sortupdate", function() { //function(event, ui) {
           var index = 0;
  ...
  function media_upload(button_class) {
        ...
        $("body").on("click", button_class, function() { //function(e) {
