 ...
 */
function testimonialHeight(){jQuery(".testimonial-section .parallax-window").css("height",jQuery(".testimonial-section .parallax-window .container").outerHeight()+150),jQuery(window).trigger("resize").trigger("scroll")}!function(i){/* Function To 
	* keep menu fixed
	**/
function e(){i(window).scrollTop()>o?//if href = #element id
n.addClass("fixed scrolled"):n.removeClass("fixed scrolled")}function t(){var i=jQuery(".masonryFlyIn .masonry-item"),e=0;i.each(function(){var i=jQuery(this);setTimeout(function(){i.addClass("fadeIn")},e),e+=170})}var n,o;jQuery(document).ready(function(i){
//"use strict";
...
jQuery(".filters.floating").length&&(setupFloatingProjectFilters(),updateFloatingFilters(),window.addEventListener("scroll",updateFloatingFilters,!1)),jQuery(".masonry").addClass("fadeIn"),jQuery(".masonry-loader").addClass("fadeOut"),jQuery(".masonryFlyIn").length&&t()}),e.layout()}
// Navigation height
